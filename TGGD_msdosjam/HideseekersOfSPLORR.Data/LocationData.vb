Public Module LocationData
    ...
    End Sub
    Function ReadForXY(x As Integer, y As Integer) As ULong?
        Initialize()
        ...
        Return Nothing
    End Function
    Function Create(x As Integer, y As Integer) As ULong
        Initialize()
    ...
    End Function
    Function ReadX(locationId As ULong) As Integer?
        Initialize()
        ...
        End Using
    End Function
    Function ReadY(locationId As ULong) As Integer?
        Initialize()
